...
import juego.niceland.ventanas.Ventana;
import juego.niceland.ventanas.VentanaComun;
import juego.niceland.ventanas.VentanaConHojas;
/**
 * 
 * @author Victor Ariel Duarte Ocampo
 *
 */
public class SeccionSuperior extends Seccion {
	...
	/**
	 * Creara una seccion superior con los atributos que corresponden.
	 */
	public SeccionSuperior() {
		super(TipoSeccion.SUPERIOR);
		for (int f=0;f<3;f++)
		{
